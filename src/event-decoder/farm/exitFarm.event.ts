...
import { FarmTokenAttributes } from '../../attributes-decoder/farm/farm.token';
...
export class ExitFarmEvent extends GenericEvent {
    ...
    getRewardReserve(): BigNumber | undefined {
    ...
    decodeEvent(version: FarmVersion) {
        if (this.data == undefined) {
            throw new ErrInvalidDataField(ExitFarmEvent.name);
        }
